...
- [Power BI project (PBIP)](powerbi/AsterCloud_FPA_PowerBI.pbip)
...
Nine processed reporting datasets
        ->
Excel management reporting, Tableau and Power BI dashboards
```
...
The same nine SQL outputs support the Excel workbook, Tableau dashboard and Power BI report:
...
The nine processed CSV files are loaded through Power Query and connected to a shared month dimension. Reusable DAX measures support four report pages: Executive Overview, Revenue & ARR, Cost & Operations, and AR & Collections.
