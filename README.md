...
Start with [`sql/end_to_end_fpa_workflow.sql`](sql/end_to_end_fpa_workflow.sql), which covers source-data audit, financial reconciliation, analytical views, and management analysis.

## Tableau dashboard

Download and open [`AsterCloud_FPA_Tableau_Dashboard.twbx`](deliverables/AsterCloud_FPA_Tableau_Dashboard.twbx) in Tableau Desktop 2026.2 or later. The packaged workbook contains all required dashboard extracts.

The four dashboard pages cover:
...
![AsterCloud Tableau executive overview](assets/tableau/01_executive_overview.png)

Additional previews: [Revenue and ARR](assets/tableau/02_revenue_arr.png) | [Cost, Headcount and Services](assets/tableau/03_cost_services.png) | [AR and Collections](assets/tableau/04_ar_collections.png)
...
- [`sql/end_to_end_fpa_workflow.sql`](sql/end_to_end_fpa_workflow.sql): end-to-end SQL workflow covering source audit, data-quality checks, financial reconciliation, analytical views, and management analysis.
...
- [`deliverables/AsterCloud_FPA_Monthly_Report.xlsx`](deliverables/AsterCloud_FPA_Monthly_Report.xlsx): formula-driven Excel management report.
- [`deliverables/AsterCloud_FPA_Tableau_Dashboard.twbx`](deliverables/AsterCloud_FPA_Tableau_Dashboard.twbx): packaged four-page Tableau dashboard.
- [`assets/tableau/`](assets/tableau/): dashboard page previews for browser review.
- [`assets/executive_summary.png`](assets/executive_summary.png): Excel executive-report preview.
...
3. Open `sql/end_to_end_fpa_workflow.sql`.
4. Run the workflow section by section:
   - source-data audit;
   - financial reconciliation and quality checks;
   - analytical views;
   - management analysis.
5. Open `deliverables/AsterCloud_FPA_Monthly_Report.xlsx` to review the Excel management reporting package.
6. Open `deliverables/AsterCloud_FPA_Tableau_Dashboard.twbx` to explore the four-page dashboard.
