...
- [Tableau dashboard](AsterCloud_FPA_Tableau_Dashboard.twbx)
- [Excel management report](AsterCloud_FPA_Monthly_Report.xlsx)
- [Oracle SQL workflow](astercloud_fpa_oracle.sql)
- [SQLite SQL workflow](astercloud_fpa_sqlite.sql)
