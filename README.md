...
Tableau-ready extracts | **Support tooling:** Node.js and Shell
...
Start with [`sql/01_create_views.sql`](sql/01_create_views.sql),
[`sql/02_analysis_queries.sql`](sql/02_analysis_queries.sql), and
[`sql/03_quality_checks.sql`](sql/03_quality_checks.sql).
